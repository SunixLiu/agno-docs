...
keywords: [sessions, team sessions, multi-turn conversations]
---
...
In practice, a session in the context of a Team is a multi-turn conversation between a user and the Team "leader". Using a `session_id`, we can connect the conversation history and state across multiple runs.
