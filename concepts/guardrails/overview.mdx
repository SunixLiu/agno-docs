...
- [PII Detection Guardrail](/concepts/guardrails/included/pii): detect PII (Personally Identifiable Information).
- [Prompt Injection Guardrail](/concepts/guardrails/included/prompt-injection): detect and stop prompt injection attemps.
- [OpenAI Moderation Guardrail](/concepts/guardrails/included/openai-moderation): detect content that violates OpenAI's content policy.

To use the Agno included guardrails, you just need to import them and pass them to the Agent or Team with the `pre_hooks` parameter. For example, to use the PII Detection Guardrail:
...
You can see complete examples using the Agno Guardrails in the [examples](/examples/concepts/agent/guardrails) section.
...
- View [Agent Examples](/examples/concepts/agent/guardrails)
- View [Team Examples](/examples/concepts/team/guardrails)
