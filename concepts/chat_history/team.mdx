...
<Note>
For all forms of session history, you need to have a database assigned to the team. See [Storage](/concepts/db/overview) for more details.
</Note>
...
<Note>
**Database Requirement**: All history features require a database configured on the team. See [Storage](/concepts/db/overview) for setup.
</Note>
