...
sidebarTitle: Agent Chat History
...
<Note>
For all forms of session history, you need to have a database assigned to the agent. See [Storage](/concepts/storage/overview) for more details.
</Note>
...
<Note>
**Database Requirement**: All history features require a database configured on the agent. See [Storage](/concepts/storage/overview) for setup.
</Note>
...
Learn more in the [Context Engineering](/concepts/context/overview) documentation.
