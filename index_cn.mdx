  ...
  <div className="relative mx-auto flex max-w-6xl flex-col px-5 sm:px-8 lg:px-10">
    ...
    <section className="mt-20 flex flex-col items-center gap-6 text-center">
      ...
      <div className="mt-12 grid w-full max-w-5xl grid-cols-1 gap-4 md:grid-cols-3">
        ...
        {/* Reference Card */}
        <a
          href="/reference/agents/agent_cn"
          className="group relative flex flex-col gap-2 rounded-xl border border-[#e5e7eb] dark:border-zinc-700 bg-[#f6f7f9] dark:bg-zinc-900 p-5 transition hover:border-[#e5e7eb] dark:hover:border-zinc-600"
        >
          <span className="pointer-events-none absolute -left-2 -top-2 h-4 w-4 border-l-2 border-t-2 border-[#ff4017] opacity-0 transition-opacity group-hover:opacity-100" />
          <span className="pointer-events-none absolute -right-2 -top-2 h-4 w-4 border-r-2 border-t-2 border-[#ff4017] opacity-0 transition-opacity group-hover:opacity-100" />
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-5 sm:px-8 lg:grid-cols-5 lg:px-10">
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="/get-started/quickstart_cn" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">快速开始</a></li>
            <li><a href="/get-started/getting-help_cn" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">获取帮助</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="/basics/agents/overview_cn" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">智能体</a></li>
            <li><a href="/basics/teams/overview_cn" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">团队</a></li>
            <li><a href="/basics/workflows/overview_cn" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">工作流</a></li>
            <li><a href="/basics/tools/overview_cn" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">工具</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="/agent-os/introduction_cn" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">总览</a></li>
            <li><a href="/agent-os/creating-your-first-os_cn" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">开始使用</a></li>
            <li><a href="/agent-os/config_cn" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">配置</a></li>
            <li><a href="/deploy/overview_cn" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">部署</a></li>
          </ul>
        </div>
