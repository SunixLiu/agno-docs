---
title: 带知识库的智能体
description: 学习如何创建一个带知识库的智能体
mode: wide
---

本示例展示了如何创建一个 AI 烹饪助手，它能够将精选食谱数据库中的知识与网络搜索功能相结合。该智能体使用了一份包含正宗泰国菜谱的 PDF 知识库，并能在需要时通过网络搜索来补充信息。

可尝试的示例提示：
- “如何制作正宗的泰式炒河粉 (Pad Thai)？”
- “红咖喱和绿咖喱有什么区别？”
- “请解释一下高良姜 (galangal) 是什么，以及可能的替代品？”
- “告诉我关于冬阴功汤 (Tom Yum) 的历史”
- “泰国厨房必备的食材有哪些？”
- “如何制作泰式打抛饭/罗勒叶炒肉 (Pad Kra Pao)？”
