...
<<<<<<< HEAD
title: 欢迎来到 Agno
description: 用Agno构建，运行和管理多代理系统. 用于创建AI智能体、团队和工作流的领先框架，配备强大的工具和部署选项。
=======
...
=======
  {
    ...
    code: (
      <>
        <span style={{ color: "#ff4017" }}>from</span> agno.agent{" "}
        <span style={{ color: "#ff4017" }}>import</span> Agent{"\n"}
        <span style={{ color: "#ff4017" }}>from</span> agno.models.anthropic{" "}
        <span style={{ color: "#ff4017" }}>import</span> Claude{"\n"}
        <span style={{ color: "#ff4017" }}>from</span> agno.tools.coding{" "}
        <span style={{ color: "#ff4017" }}>import</span> CodingTools{"\n"}
        {"\n"}
        agent = Agent({"\n"}
        {"    "}model=Claude(id=
        <span style={{ color: "#c3e88d" }}>"claude-sonnet-4-5"</span>),{"\n"}
        {"    "}tools=[CodingTools()],{"\n"}
        {"    "}add_history_to_context=
        <span style={{ color: "#ff4017" }}>True</span>,{"\n"}
        {"    "}markdown=<span style={{ color: "#ff4017" }}>True</span>,{"\n"}
        ){"\n"}
        {"\n"}
        ...
        , stream=<span style={{ color: "#ff4017" }}>True</span>)
      </>
    ),
  },
  {
    ...
    code: (
      <>
        <span style={{ color: "#ff4017" }}>from</span> agno.team{" "}
        <span style={{ color: "#ff4017" }}>import</span> Team{"\n"}
        <span style={{ color: "#ff4017" }}>from</span> agno.agent{" "}
        <span style={{ color: "#ff4017" }}>import</span> Agent{"\n"}
        <span style={{ color: "#ff4017" }}>
          from
        </span> agno.models.anthropic{" "}
        <span style={{ color: "#ff4017" }}>import</span> Claude{"\n"}
        <span style={{ color: "#ff4017" }}>
          from
        </span> agno.tools.hackernews{" "}
        <span style={{ color: "#ff4017" }}>import</span> HackerNewsTools{"\n"}
        <span style={{ color: "#ff4017" }}>
          from
        </span> agno.tools.newspaper4k{" "}
        <span style={{ color: "#ff4017" }}>import</span> Newspaper4kTools{"\n"}
        {"\n"}
        hn_researcher = Agent(name=
        <span style={{ color: "#c3e88d" }}>"HackerNews Researcher"</span>,
        tools=[HackerNewsTools()]){"\n"}
        article_reader = Agent(name=
        <span style={{ color: "#c3e88d" }}>"Article Reader"</span>,
        tools=[Newspaper4kTools()]){"\n"}
        {"\n"}
        team = Team({"\n"}
        {"    "}model=Claude(id=
        ...
        team.print_response(
        <span style={{ color: "#c3e88d" }}>
          "Research AI trends and summarize the top articles"
        </span>
        )
      </>
    ),
  },
  {
    ...
    code: (
      <>
        <span style={{ color: "#ff4017" }}>from</span> agno.agent{" "}
        <span style={{ color: "#ff4017" }}>import</span> Agent{"\n"}
        <span style={{ color: "#ff4017" }}>from</span> agno.workflow{" "}
        <span style={{ color: "#ff4017" }}>import</span> Workflow{"\n"}
        <span style={{ color: "#ff4017" }}>
          from
        </span> agno.models.anthropic{" "}
        <span style={{ color: "#ff4017" }}>import</span> Claude{"\n"}
        <span style={{ color: "#ff4017" }}>
          from
        </span> agno.tools.duckduckgo{" "}
        <span style={{ color: "#ff4017" }}>import</span> DuckDuckGoTools{"\n"}
        {"\n"}
        researcher = Agent(name=
        <span style={{ color: "#c3e88d" }}>"Researcher"</span>, model=Claude(id=
        <span style={{ color: "#c3e88d" }}>"claude-sonnet-4-5"</span>),
        tools=[DuckDuckGoTools()]){"\n"}
        writer = Agent(name=<span style={{ color: "#c3e88d" }}>"Writer"</span>,
        model=Claude(id=
        <span style={{ color: "#c3e88d" }}>"claude-sonnet-4-5"</span>),
        instructions=
        <span style={{ color: "#c3e88d" }}>"Write engaging content"</span>)
        {"\n"}
        {"\n"}
        workflow = Workflow({"\n"}
        {"    "}name=
        <span style={{ color: "#c3e88d" }}>"Content Workflow"</span>,{"\n"}
        {"    "}steps=[researcher, writer],{"\n"}){"\n"}
  ...
  },
  {
    ...
    code: (
      <>
        <span style={{ color: "#ff4017" }}>from</span> agno.os{" "}
        <span style={{ color: "#ff4017" }}>import</span> AgentOS{"\n"}
        <span style={{ color: "#ff4017" }}>from</span> agno.agent{" "}
        <span style={{ color: "#ff4017" }}>import</span> Agent{"\n"}
        <span style={{ color: "#ff4017" }}>from</span> agno.db.sqlite{" "}
        <span style={{ color: "#ff4017" }}>import</span> SqliteDb{"\n"}
        <span style={{ color: "#ff4017" }}>from</span> agno.tools.mcp{" "}
        <span style={{ color: "#ff4017" }}>import</span> MCPTools{"\n"}
        <span style={{ color: "#ff4017" }}>
          from
        </span> agno.models.anthropic{" "}
        <span style={{ color: "#ff4017" }}>import</span> Claude{"\n"}
        ...
        <span style={{ color: "#c3e88d" }}>"claude-sonnet-4-5"</span>),{"\n"}
        {"    "}db=SqliteDb(db_file=
        <span style={{ color: "#c3e88d" }}>"agno.db"</span>),{"\n"}
        {"    "}tools=[MCPTools(url=
        <span style={{ color: "#c3e88d" }}>"https://docs.agno.com/mcp"</span>)],
        {"\n"}
        {"    "}add_history_to_context=
        <span style={{ color: "#ff4017" }}>True</span>,{"\n"}
        {"    "}markdown=<span style={{ color: "#ff4017" }}>True</span>,{"\n"})
        ...
        <span style={{ color: "#71717a" }}># FastAPI app ready to deploy</span>
      </>
    ),
  },
>>>>>>> main
...
>>>>>>> main
      ...
      <div className="mt-12 grid w-full max-w-5xl grid-cols-1 gap-4 md:grid-cols-3">
        ...
        >
          ...
          <h3 className="text-base font-semibold text-start text-zinc-900 dark:text-zinc-100">开始使用</h3>
...
>>>>>>> main
        ...
        {/* Reference Card */}
        <a
          href="zh/reference/agents/agent"
          className="group relative flex flex-col gap-2 rounded-xl border border-[#e5e7eb] dark:border-zinc-700 bg-[#f6f7f9] dark:bg-zinc-900 p-5 transition hover:border-[#e5e7eb] dark:hover:border-zinc-600"
        >
          <span className="pointer-events-none absolute -left-2 -top-2 h-4 w-4 border-l-2 border-t-2 border-[#ff4017] opacity-0 transition-opacity group-hover:opacity-100" />
          <span className="pointer-events-none absolute -right-2 -top-2 h-4 w-4 border-r-2 border-t-2 border-[#ff4017] opacity-0 transition-opacity group-hover:opacity-100" />
...
<<<<<<< HEAD
          <h3 className="text-base font-semibold text-start text-zinc-900 dark:text-zinc-100">参考文档</h3>
=======
          <h3 className="text-base font-semibold text-start text-zinc-900 dark:text-zinc-100">Deploy</h3>
>>>>>>> main
          <p className="text-xs leading-relaxed text-start text-zinc-500 dark:text-zinc-400">
            面向开发者的完整 SDK 和 API 参考文档
          </p>
        </a>
      </div>
    </section>
    ...
    <section className="mt-20 flex flex-col gap-6">
      <div className="flex flex-col gap-2 text-center">
        <p className="text-xs font-semibold uppercase tracking-[0.35em] text-zinc-500 dark:text-zinc-400">使用 agno 构建</p>
      </div>
    ...
    <section className="mt-20 pb-12">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-5 sm:px-8 lg:grid-cols-5 lg:px-10">
        <div>
          <h3 className="mb-4 text-xs font-semibold uppercase tracking-wider text-zinc-900 dark:text-zinc-100">开始使用</h3>
          <ul className="space-y-3">
            <li><a href="zh/get-started/quickstart" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">快速开始</a></li>
            <li><a href="zh/get-started/getting-help" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">获取帮助</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="zh/basics/agents/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">智能体</a></li>
            <li><a href="zh/basics/teams/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">团队</a></li>
            <li><a href="zh/basics/workflows/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">工作流</a></li>
            <li><a href="zh/basics/tools/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">工具</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="zh/agent-os/introduction" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">总览</a></li>
            <li><a href="zh/agent-os/creating-your-first-os" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">开始使用</a></li>
            <li><a href="zh/agent-os/config" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">配置</a></li>
            <li><a href="zh/deploy/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">部署</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="zh/reference/agents/agent" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">SDK Reference</a></li>
            <li><a href="zh/reference-api/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">API Reference</a></li>
            <li><a href="zh/examples/use-cases/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">Examples</a></li>
            {/* <li><a href="zh/templates/overview" className="text-sm text-zinc-500 transition hover:text-[#ff4017]">Templates</a></li> */}
          </ul>
        </div>
