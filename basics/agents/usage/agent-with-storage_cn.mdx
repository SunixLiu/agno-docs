...
description: 了解如何创建带有长期存储的智能体
mode: wide
---

本示例展示了如何创建一个 AI 烹饪助手，该助手结合了精选食谱数据库的知识、网络搜索功能以及持久化存储。该智能体使用一份关于正宗泰国菜的 PDF 知识库，并且在需要时能够通过网络搜索来补充信息。

可尝试的示例提示：
- "如何制作正宗的泰式炒河粉（Pad Thai）？"
- "红咖喱和绿咖喱有什么区别？"
- "请解释一下高良姜（galangal）是什么，以及可能的替代品？"
- "给我讲讲冬阴功汤（Tom Yum）的历史。"
- "泰国菜烹饪必备的食材有哪些？"
- "如何制作泰式打抛猪（泰式 basil 炒鸡）？"
